...
#+DESCRIPTION: Even my terminal deserves version control therapy.

[[file:painting.jpg]]

/"Woman at a Window" (1822) by Caspar David Friedrich, [[https://en.wikipedia.org/wiki/Woman_at_a_Window_(Friedrich)][Wikipedia]]/
...
The core philosophy is simple: selecting text should copy it. Combined with the Emacs keybindings in the [[https://github.com/pdelfino/zshrc][zshrc]] config, this creates a fully keyboard-driven terminal where kill/yank operations and mouse selection both feed into the same system clipboard.
...
|------+------------------|
| [[https://github.com/pdelfino/emacs-config][emacs-config]] | Emacs setup with Ivy, Paredit, Claude Code integration |
...
| [[https://github.com/pdelfino/zshrc][zshrc]] | ZSH config with Emacs bindings and clipboard sync |
